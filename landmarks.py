...
class landmarks(dml.Algorithm):
    ...
    def execute(trial = False):
        ...
        after_p = project(select(Landmarks, lambda t: float(t[7]) > 15), lambda t: (t[7],t[8],t[9],t[10],t[11],t[16],t[17]))
        after_pp = project(after_p, lambda t: (t[0], t[1],t[2],t[3],t[4],float(t[5])//float(t[6])))
        column_names = ['Petition', 'Name of landmarks', 'Areas_Desi','Address','Neighbourhood','ShapeSTWidth']
